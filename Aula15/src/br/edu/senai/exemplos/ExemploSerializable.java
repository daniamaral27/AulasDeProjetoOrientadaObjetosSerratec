...
public class ExemploSerializable {
	...
	public static void main(String[] args) {
		...
		Fornecedor fornecedor3 = new Fornecedor("4345454", "TDAS/A", "tda@tda.com");
...
//		try {
//			FileOutputStream arquivoGravar = new FileOutputStream("/exemplos/fornecedor2.dat");
...
//			e.printStackTrace();
	...
	System.out.println("--------Recuperando Objetos-----------");
		...
		FileInputStream arquivoLeitura = new FileInputStream("/exemplos/fornecedor2.dat");
