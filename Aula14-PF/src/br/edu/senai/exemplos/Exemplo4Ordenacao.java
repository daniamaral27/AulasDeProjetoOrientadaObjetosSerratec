...
public class Exemplo4Ordenacao {
	...
	public static void main(String[] args) {
		...
		System.out.println("========Ordenando pela idade antes do Java8");
		alunos.stream().sorted().forEach(n -> System.out.println(n));

		System.out.println("========Ordenando pela idade depois do Java8");
		Comparator<Aluno> ordenarPeloNome = (o1,o2) -> o1.getNome().
				compareTo(o2.getNome());
		Collections.sort(alunos, ordenarPeloNome);
		alunos.forEach(a-> System.out.println(a));
		
		System.out.println("----Ordenando por email Java 8--------");
